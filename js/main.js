class Validator {
	...
	validate(form) {
	  ...
	  // pegar todos inputs
	  let inputs = form.querySelectorAll('input[data-min-length], input[data-max-length], input[data-only-letters], input[data-email-validate], input[data-required], input[data-equal], input[data-password-validate]');
